    ...
    <div class="banner-area">
            <div class="single-banner">
                <div class="banner-text">
                    ...
                    <P>Unlock your adventure with MRKTPLC
                    <br> Your one-stop shop for affordable and hassle-free car rentals 
                        ...
                        <div class="banner-btn" a href="companyregister.php">JOIN US</div>
                </div>
            </div>
            ...
            <div class="single-banner">
                <div class="banner-text">
                    ...
                    <P>
                    <br>Welcome to MRKTPLC! We are a leading online marketplace for car rentals, connecting both individuals and rental companies with those in need of affordable and reliable transportation. 
                    ...
                    <br>Thank you for choosing MRKTPLC, and we look forward to helping you find the perfect car rental for your needs!
                     <br> 
                     <br> 
                     <br>
                     </P>
